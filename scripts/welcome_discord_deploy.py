...
from cogs.guild_registry import SHADOW_MAIN_GUILD_ID, ch_id  # noqa: E402
from cogs.welcome import PANEL_TITLE, VANITY_INVITE_URL, build_welcome_embed  # noqa: E402
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if not panels:
            ...
            if status not in (200, 201):
                raise RuntimeError(f"Post failed: {status} {panel}")
            mid = panel["id"]
