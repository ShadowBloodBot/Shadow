...
class ShadowControlPanel(View):
    def __init__(self, bot, author):
        ...
        self.add_item(Button(label="Mass Ban", style=discord.ButtonStyle.red, custom_id="mass_ban"))
    ...
    async def on_button_click(self, interaction: discord.Interaction, custom_id: str):
        ...
        elif custom_id == "mass_ban":
            await handle_mass_action(interaction, action="ban")
        elif custom_id == "shadow_mute":
            await handle_shadowmute(interaction)
